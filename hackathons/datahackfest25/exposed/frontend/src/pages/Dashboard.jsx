    ...
    >
        ...
        {!analysis && (
          <div style={{ padding: "4rem 0" }}>
            <div style={{ textAlign: "center", marginBottom: "3rem" }}>
              ...
              >
                Upload your TikTok data export and discover the patterns,
                habits, and personality traits hidden in your digital footprint.
              </p>
              ...
              <div style={{ textAlign: "center", marginBottom: "2rem" }}>
                ...
                >
                  Don't have your data yet? Click above for step-by-step
                  instructions
                </p>
              </div>
            </div>
                ...
                <label
                  ...
                  onMouseOut={(e) => {
                    if (!isDragOver) {
                      ...
                      e.target.style.backgroundColor = file
                        ? "#f0fdf4"
                        : "transparent";
                    }
                  }}
              ...
              {isLoading ? (
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundSize: "200% 200%",
                    animation: file
                      ? "tiktokGradient 4s ease infinite"
                      : "none",
                  }}
                  onMouseOver={(e) => {
                    if (file) {
        ...
        {analysis && (
          <div style={{ padding: "2rem 0", marginBottom: "3rem" }}>
            ...
            >
              ...
              >
                Here's what your TikTok data reveals about your digital behavior
                and personality
              </p>
            </div>
            ...
            <div style={{ marginBottom: "3rem" }}>
              ...
              >
                ...
                >
                  ...
                  <p style={{ fontSize: "0.875rem", color: "#6b7280" }}>
                    From {analysis.summary.longestStreak.startDate} to{" "}
                    {analysis.summary.longestStreak.endDate}
                  </p>
                </div>
                ...
                >
                  ...
                  <p style={{ fontSize: "0.875rem", color: "#6b7280" }}>
                    On{" "}
                    {new Date(
                      analysis.summary.mostActiveDay.date,
                    ).toLocaleDateString()}
                  </p>
                </div>
              </div>
              ...
              <div style={{ marginBottom: "3rem" }}>
                ...
                >
                  ...
                  {analysis.summary.hashtags &&
                    analysis.summary.hashtags.length > 0 && (
                      <div
                        style={{
                          backgroundColor: "white",
                          padding: "2rem",
                ...
                {analysis.summary.comments.longestComments &&
                  analysis.summary.comments.longestComments.length > 0 && (
                    <div
                      style={{
                        backgroundColor: "white",
                        padding: "2rem",
                  ...
                  >
                    {Object.entries(analysis.summary.activityOverTime)
                      ...
                      .map(([month, activity], index) => {
                        ...
                        const percentage =
                          maxActivity > 0
                            ? ((activity.videos || 0) / maxActivity) * 100
                            : 0;
            ...
            <div style={{ marginBottom: "3rem" }}>
              ...
              {analysis.summary.dailyActivity && (
                ...
                >
                  ...
                  >
                    GitHub-style contribution calendar showing your daily TikTok
                    activity
                  </p>
                  <ActivityHeatmap
                    dailyActivity={analysis.summary.dailyActivity}
                  />
                </div>
              )}
              ...
              >
                ...
                {analysis.summary.hourlyActivity && (
                  ...
                  >
                    ...
                    <ActivityClock
                      hourlyActivity={analysis.summary.hourlyActivity}
                    />
                  </div>
                )}
                ...
                {analysis.summary.weeklyActivity && (
                  ...
                  >
                    ...
                    <WeeklyPattern
                      weeklyActivity={analysis.summary.weeklyActivity}
                    />
                  </div>
                )}
              </div>
              ...
              {analysis.summary.engagementTrends && (
                ...
                >
                  ...
                  >
                    Multi-line chart tracking your videos, likes, comments, and
                    searches
                  </p>
                  <EngagementTrends
                    engagementTrends={analysis.summary.engagementTrends}
                  />
                </div>
              )}

              {/* Word Clouds */}
              {analysis.summary.comments.topCommentWords &&
                Object.keys(analysis.summary.comments.topCommentWords).length >
                  0 && (
                  <div
                    style={{
                      display: "grid",
                  ...
                  >
                    ...
                    {analysis.summary.topSearches &&
                      analysis.summary.topSearches.length > 0 && (
                        <div
                          style={{
                            backgroundColor: "white",
                            padding: "2rem",
                        ...
                        >
                          ...
                          <WordCloud
                            words={analysis.summary.topSearches.reduce(
                              (acc, [term, count]) => {
                                acc[term] = count;
                                return acc;
                              },
                ...
                {[
                  {
                    ...
                    title: "Take Breaks",
                    description:
                      "Consider setting daily limits on your social media usage",
                    color: "#10b981",
                  },
                  {
                    icon: "🧠",
                  ...
                  },
                  {
                    ...
                    description:
                      "Regularly review your privacy settings and data sharing",
                    color: "#8b5cf6",
                  },
                ].map((tip, index) => (
                  <div
      ...
      <footer style={{ padding: "2rem", textAlign: "center" }}>
        ...
        >
          <span>🔒</span>
          <span>
            Built with ❤️ for Data Hackfest 2025 • Privacy First • AI Powered
          </span>
        </p>
      </footer>
